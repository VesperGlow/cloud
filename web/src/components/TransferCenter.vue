...
.transfer-empty{display:grid;place-items:center;padding:34px;color:#94a3b8}.transfer-empty span{font-size:28px}.transfer-empty p{margin:8px 0 0;font-size:12px}@keyframes spin{to{transform:rotate(270deg)}}
